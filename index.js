...
exports.default = _default;
        var $133579 = exports.default || module.exports;
      
      if (typeof $133579 === 'function') {
        $133579 = $133579.options;
      }
    
        /* template */
        Object.assign($133579, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "div",
    { staticClass: "k-block-type-grid", on: { dblclick: _vm.open } },
    [
      _c(
        "k-layout-field",
        _vm._b(
          {
            attrs: { value: _vm.content.grid, label: _vm.content.title },
            on: {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$133579', $133579);
          } else {
            api.reload('$133579', $133579);
          }
        }
...
panel.plugin("microman/grid-blocks", {
  blocks: {
    grid: _Grid.default
  },
  icons: {
...
},{"./components/Grid.vue":"components/Grid.vue"}],"../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
